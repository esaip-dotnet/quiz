<%@ Page Title="Inscrire une connexion externe" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="Quiz.Account.RegisterExternalLogin" Async="true" %>
