...
MongoClient.connect(url, function (err, db) {
    if (err) {
        ...
        // Obtenir la collection du document
        var resultat = db.collection('quiz');
        //Notre tableau de quiz
        var allQuiz = new Array();
        //On recupère les quiz en bdd et on les ajoutent a notre tableau.
        ...
        app.get('/quiz', function(req, res) {
            var myJson = JSON.stringify(allQuiz); // Convertir le tableau en objet JSON
