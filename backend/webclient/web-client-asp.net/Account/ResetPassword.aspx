<%@ Page Title="Réinitialiser le mot de passe" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="Quiz.Account.ResetPassword" Async="true" %>
